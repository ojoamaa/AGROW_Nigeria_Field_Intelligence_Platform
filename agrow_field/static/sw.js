const CACHE='agrow-field-v4-central-sync'; const CORE=['/','/manifest.webmanifest','/assets/app.js','/assets/style.css','/assets/icons/icon-192.png','/assets/icons/icon-512.png'];
