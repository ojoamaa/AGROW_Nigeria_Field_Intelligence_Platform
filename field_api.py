...
class FieldRecord(BaseModel):
    farmer_id:str; registration_date:str; farmer_full_name:str; gender:str=''; date_of_birth:str=''; phone_number:str; alternate_phone:str=''; email_address:str=''; nin:str=''; state:str; lga:str; ward:str=''; community_village:str=''; residential_address:str=''; primary_crop:str=''; secondary_crop:str=''; farm_size_ha:float=0; support_needs:str=''; support_priority:str=''; programme_name:str=''; input_distributed:str=''; quantity_units:int=0; nin_status:str='Pending'; id_type:str=''; id_number:str=''; latitude:float; longitude:float; gps_accuracy:Optional[float]=None; enumerator_remarks:str=''; photo_data:str=''; photo_mime:str='image/jpeg'
